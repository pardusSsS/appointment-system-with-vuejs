...
<div class="container">
    ...
    <admin-working-item day="monday" @add="add" title="Pazartsi" :data="monday"></admin-working-item>
    ...
    <button @click="store" class="btn btn-success">Kaydet</button>
...
<script>
    export default {
        ...
        created() {
            axios.get(`http://192.168.1.5:8000/api/working-list`).then((res)=>{
